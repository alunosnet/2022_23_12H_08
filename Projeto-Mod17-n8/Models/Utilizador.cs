...
namespace M17AB_TrabalhoModelo_202223.Models
{
    public class Utilizador
    {
        ...
        {
            string sql = @"INSERT INTO utilizadores(email,nome,nif,password,estado,perfil,sal)
                            VALUES (@email,@nome,@nif,HASHBYTES('SHA2_512',concat(@password,@sal)),@estado,@perfil,@sal)";
        ...
        {
            string sql = @"UPDATE utilizadores SET nome=@nome,nif=@nif 
                            WHERE id=@id";
